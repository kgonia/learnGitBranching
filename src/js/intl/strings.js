exports.strings = {
  ...
  'finish-dialog-finished': {
    ...
    'pl': 'Super! Ukończyłeś ostatni poziom!'
  },
  ///////////////////////////////////////////////////////////////////////////
  'finish-dialog-next': {
    '__desc__': 'One of the lines in the next level dialog',
    ...
    'pl': 'Chcesz przejść do kolejnego poziomu? - *"{nextLevel}"*',
  },
  ///////////////////////////////////////////////////////////////////////////
  'finish-dialog-win': {
    '__desc__': 'One of the lines in the next level dialog',
    ...
    'pl': 'Super! Twoje rozwiązanie pasuje do naszego rozwiązania'
  },
  ///////////////////////////////////////////////////////////////////////////
  'finish-dialog-lose': {
    ...
    'pl': 'Sprawdź czy możesz to zrobić lepiej',
  },
  ///////////////////////////////////////////////////////////////////////////
  'hg-prune-tree': {
    ...
    'pl': 'Uważaj! Mercurial dokonuje agresywnego usuwania kolekcji. Musisz przyciąć gałąź.'
  },
  ///////////////////////////////////////////////////////////////////////////
  'hg-a-option': {
    ...
    'pl': 'Parametr -A nie jest potrzebny w tej aplikacji, poprostu commituj'
  },
  ///////////////////////////////////////////////////////////////////////////
  'hg-error-no-status': {
    ...
    'pl': 'W tej aplikacji nie ma komendy status, ponieważ nie operuje na aplikach ani nie posaida przechowywalni (stage). Spróbuj komendy hg summary'
  },
  ///////////////////////////////////////////////////////////////////////////
  'hg-error-need-option': {
    ...
    'pl': 'Do tej komeny potrzebna jest opcja {option}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'hg-error-log-no-follow': {
    ...
    'pl': 'hg log bez parametru -f nie jest wspierany, użyj parametru -f',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-status-detached': {
  ...
  'git-status-readytocommit': {
    ...
    'pl': 'Gotowe do commitu! (jak zawsze w tym demie)',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-dummy-msg': {
  ...
  'git-error-origin-fetch-no-ff': {
    ...
    'pl': 'Branch origin nie jest zsynchronizowany z zewnętrznym branchem. Pobranie zmian nie może nastapić',
  },
  'git-error-origin-push-no-ff': {
    ...
    'pl': 'Zewnętrzne repozytorium różni się od lokalnego, więc załadowanie Twoich zmian nie jest prostym przejściem do przodu (dlatego Twóje zmiany zostaną odrzucone. Proszę pobierz nowe zmiany z zewnętrznego repozytorium, połącz jest z Twoim branchem i spróbuj znowu. Możesz to osiągnąć wywołując komendę git pull albo git pull --rebase'
  },
  'git-error-remote-branch': {
    ...
    'pl': 'Nie możesz wykonać tej komendy na zewnętrznym branchu',
  },
  'git-error-origin-required': {
    ...
    'pl': 'Zewnętrzbe repozytorium jest wymagane do wywołania tej komendy',
  },
  'git-error-origin-exists': {
    ...
    'pl': 'Zewnętrzne repozytorium o nazwie origin już istnieje! Nie możesz stworzyć kolejnego',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-branch': {
    '__desc__': 'One of the error messages for git',
    ...
    'pl': 'Nie możesz usunąć bracha master, brancha na którym jesteś lub nie stworzyłeś brancha',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-merge-msg': {
    ...
    'pl': 'Połączenie (merge) {target} do {current}'
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-rebase-none': {
    ...
    'pl': 'Nie ma commitów do wykonania rebase! Wszystkie commity są już zmergowane albo nei ma innych zmian.',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-result-nothing': {
  ...
  'git-result-uptodate': {
    ...
    'ko': '브랜치가 이미 최신 상태입니다.',
    'pl': 'Branch już posiada najnowsze zmiany',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-exist': {
    '__desc__': 'One of the error messages for git',
    ...
    'pl': '{ref} nie istnieje albo jest nieznany',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-relative-ref': {
    ...
    'pl': 'Commit{commit} nie pasuje do {match}.',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-warning-detached': {
    ...
    'ko': '주의! 분리된 HEAD 상태',
    'pl': 'Uwaga! Znajdujesz się w stanie Detached HEAD',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-warning-add': {
    '__desc__': 'One of the warning messages for git',
  ...
  'git-error-options': {
    ...
    'pl': 'Podane parametry są błędne lub nie mogą być użyte razem',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-already-exists': {
    ...
    'pl': 'Commit {commit} już istnieje. Przerywam!',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-reset-detached': {
    ...
    'pl': 'Nie można resetować w stanie Detached HEAD! Użyj komendy checkout jeśli chcesz kontynuować',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-warning-hard': {
    '__desc__': 'One of the warning messages for git',
    ...
    'pl': 'Domyślą opcją resetu w tym demie jest --hard. Pamiętaj, używając gita domyślnie reset jest z opcją --mixed',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-staging': {
    '__desc__': 'One of the error messages for git',
    ...
    'pl': 'W tym demie nie można dodać plików do przechowywalni. Komenda jest niepoprawna!',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-revert-msg': {
    ...
    'pl': 'Cofanie zmian {oldCommit}:{oldMsg}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-args-many': {
    '__desc__': 'One of the error messages for git',
    ...
    'pl': 'Oczekuję maksymalnie {upper} argumentów do {what}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-args-few': {
    '__desc__': 'One of the error messages for git',
    ...
    'pl': 'Oczekuję przynajmnie {lower} argumentów do {what}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-error-no-general-args': {
    ...
    'pl': 'Ta komenda nie akcjeptuje argumentów',
  },
  ///////////////////////////////////////////////////////////////////////////
  'copy-tree-string': {
  ...
  'branch-name-short': {
    ...
    'pl': 'Przepraszam, musimy utrzymać krótkie nazwy branchy dla lepszej widoczności. Nazwa Twojego brancha zostanie skrócona do 9 znaków: {branch}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'bad-branch-name': {
    ...
    'pl': 'Taka nazwa "{branch}" brancha nie jest dozwolona',
  },
  ///////////////////////////////////////////////////////////////////////////
  'bad-tag-name': {
    ...
    'pl': 'Taka nazwa "{tag}" tagu nie jest dozwolona',
  },
  ///////////////////////////////////////////////////////////////////////////
  'option-not-supported': {
    ...
    'pl': 'Parametr "{option}" nie jest wspierany',
  },
  ///////////////////////////////////////////////////////////////////////////
  'git-usage-command': {
  ...
  'locale-command': {
    ...
    'pl': 'Lokalizacja ustawiona na {locale}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'locale-reset-command': {
    ...
    'pl': 'Domyslne ustawienia lokalizacji przywrócone, Obcene ustawienie to {locale}',
  },
  ///////////////////////////////////////////////////////////////////////////
  'show-command': {
    ...
    'pl': 'Użyj jednej z poniższych komend aby uzyskać więcej informacji:',
  },
  ///////////////////////////////////////////////////////////////////////////
  'show-all-commands': {
    ...
    'pl': 'Lista wszystkich dostępnych komend:',
  },
  ///////////////////////////////////////////////////////////////////////////
  'cd-command': {
    ...
    'pl': 'Katalog zmieniony na "/directories/dont/matter/in/this/demo"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'ls-command': {
    '__desc__': 'Dummy command output for the command in the key',
    ...
    'pl': 'NiePrzejmujeSiePlikamiWTymDemo.txt',
  },
  'mobile-alert': {
    ...
    'pl': 'Na urządzenia mobilnych nie można podawać komend. Spróbuj na komputerze! Warto :D',
  },
  ///////////////////////////////////////////////////////////////////////////
  'share-tree': {
    ...
    'pl': 'Podziel się strukturą drzewa ze znajomymi! Mogą załadować ją uzywając komendy "import tree"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'paste-json': {
  ...
  'solved-map-reset': {
    ...
    'pl': 'Mapa rozwiązań została zresetowana. Zaczynasz od początku!',
  },
  ///////////////////////////////////////////////////////////////////////////
  'level-cant-exit': {
    ...
    'pl': 'Nie wykonujesz żadnego poziomu, jesteś w trybie piaskownicy. Zacznij poziom wybierają "poziomy"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'level-no-id': {
    ...
    'pl': 'Nie odnaleziono poziomu z id "{id}"! Otwieranie okna z wybortem poziomów',
  },
  ///////////////////////////////////////////////////////////////////////////
  'undo-stack-empty': {
  ...
  'already-solved': {
    ...
    'pl': 'Już ukończyłeś ten poziom, spróbuj inny wybierając "poziomy" lub przejdź do trybu piaskownicy',
  },
  ///////////////////////////////////////////////////////////////////////////
  'solved-level': {
  ...
  'command-disabled': {
    ...
    'pl': 'Ta komenda jest wyłączona dla tego poziomu'
  },
  ///////////////////////////////////////////////////////////////////////////
  'share-json': {
    ...
    'pl': 'Tutaj jest JSON dla tego poziomu! Podziel się z kimś lub wyślij do do mnie na Githubie',
  },
  ///////////////////////////////////////////////////////////////////////////
  'want-start-dialog': {
    ...
    'pl': 'Nie określiłeś powitania, chcesz je dodać?',
  },
  ///////////////////////////////////////////////////////////////////////////
  'want-hint': {
    ...
    'pl': 'Nie dodałeś żadnej wskazówki, chcesz ją dodać?',
  },
  ///////////////////////////////////////////////////////////////////////////
  'prompt-hint': {
    ...
    'pl': 'Dodaj wskazówkę dla tego poziomu albo zostaw pole puste jeśli nie chcesz dodawać wskazówek',
  },
  ///////////////////////////////////////////////////////////////////////////
  'prompt-name': {
  ...
  'solution-empty': {
    ...
    'pl': 'Twoje rozwiązanie jest puste! Coś tu nie gra',
  },
  ///////////////////////////////////////////////////////////////////////////
  'define-start-warning': {
    ...
    'pl': 'Definiowanie punktu startowego... rozwiązanie i cel zostaną nadpisane jeśli były zdefiniowane wcześniej',
  },
  ///////////////////////////////////////////////////////////////////////////
  'help-vague-level': {
    ...
    'pl': 'Jesteś w trakcie rozwiązywania poziomu więc kilka form pomocy jest dostępnych. Proszę wybierz "help level" aby dowiedzieć się więcej o tej lekcji, wybierz "help general" aby dowiedzieć się więcej na temat używania Learn GitBranching, albo "objective" aby dowiedzieć się jak rozwiązać ten poziom ' ,
  },
  ///////////////////////////////////////////////////////////////////////////
  'help-vague-builder': {
    ...
    'pl': 'Jesteś w kreatorze poziomów, kilka form pomocy jest dostępnych. Proszę wybierz "help general" albo "help builder"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'show-goal-button': {
  ...
  'goal-only-master': {
    ...
    'pl': '<span class="fwber">Note:</span> Tylko branch master będzie sprawdzany na tym poziomie. Inne branche są tylko dla porównania (pokazane poniżej jako przerywane etykiety). Jak zawsze możesz schować te okno komendą "hide goal"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'hide-goal': {
    ...
    'pl': 'Możesz zamknąć te okno komendą "hide goal"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'hide-start': {
    ...
    'pl': 'Możesz zamknąć te okno komendą "hide start"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'level-builder': {
  ...
  'no-start-dialog': {
    ...
    'pl': 'Nie ma okna startowego dla tego poziomu!',
  },
  ///////////////////////////////////////////////////////////////////////////
  'no-hint': {
    ...
    'pl': 'Wygląda na to, że nie ma podpowiedzi dla tego poziomu',
  },
  ///////////////////////////////////////////////////////////////////////////
  'error-untranslated-key': {
    ...
    'pl': 'Tłumaczenie dla klucza {key} jeszcze nie istnieje :( Proszę przejdź na github i zaooferuj tłumaczenie',
  },
  ///////////////////////////////////////////////////////////////////////////
  'error-untranslated': {
    ...
    'pl': 'Ten komunikat nie jest jeszcze przetłumaczone na Twój język :( Wejdź na github i pomóż w tłumaczeniu!',
  }
};
